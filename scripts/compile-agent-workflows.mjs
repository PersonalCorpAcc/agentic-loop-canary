// Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/scripts/compile-agent-workflows.mjs. Profile digest: 1a8a08322b06. Update with `workflows update --force`; consumer edits may be overwritten.
