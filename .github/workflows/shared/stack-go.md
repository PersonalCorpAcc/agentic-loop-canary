---
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/stacks/go/pack.yml. Profile digest: 654c856ebf0e. Update with `workflows update --force`; consumer edits may be overwritten.
network:
  allowed:
    - defaults
    - go
