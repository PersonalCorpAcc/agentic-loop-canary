---
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/workflows/agent-merge-gate.md. Profile digest: 3c7498ae4594. Update with `workflows update --force`; consumer edits may be overwritten.
env:
