#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/resolve-change-linkage/resolve-change-linkage.sh. Profile digest: 7da3f578364e. Update with `workflows update --force`; consumer edits may be overwritten.
#
