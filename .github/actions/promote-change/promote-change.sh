#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/promote-change/promote-change.sh. Profile digest: ca96e80f128f. Update with `workflows update --force`; consumer edits may be overwritten.
#
