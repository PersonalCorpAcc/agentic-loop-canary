#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/validate-triage-output/validate-triage-output.sh. Profile digest: 588652f49de4. Update with `workflows update --force`; consumer edits may be overwritten.
