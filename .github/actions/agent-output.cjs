// Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/agent-output.cjs. Profile digest: edd833fb9ae5. Update with `workflows update --force`; consumer edits may be overwritten.
