// Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/agent-output.cjs. Profile digest: 654c856ebf0e. Update with `workflows update --force`; consumer edits may be overwritten.
