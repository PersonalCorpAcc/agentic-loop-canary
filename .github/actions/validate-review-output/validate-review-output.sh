#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/validate-review-output/validate-review-output.sh. Profile digest: 685c377153a2. Update with `workflows update --force`; consumer edits may be overwritten.
