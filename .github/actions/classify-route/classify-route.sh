#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/classify-route/classify-route.sh. Profile digest: beaf94f47bcb. Update with `workflows update --force`; consumer edits may be overwritten.
