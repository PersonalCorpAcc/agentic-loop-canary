#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/update-changelog/update-changelog.sh. Profile digest: a586f6e065d0. Update with `workflows update --force`; consumer edits may be overwritten.
#
