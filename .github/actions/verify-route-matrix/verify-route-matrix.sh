#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/verify-route-matrix/verify-route-matrix.sh. Profile digest: 588652f49de4. Update with `workflows update --force`; consumer edits may be overwritten.
...
readonly ROUTE_MODELS="agent-implement.md=claude-sonnet-5 agent-refine.md=claude-sonnet-5 agent-triage.md=claude-sonnet-5 agent-apply-review.md=claude-sonnet-5 agent-merge-gate.md=claude-sonnet-5 agent-audit.md=claude-sonnet-5 agent-release.md=claude-haiku-4-5"
