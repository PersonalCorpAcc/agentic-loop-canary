#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.5.1. Source: loops/actions/verify-route-matrix/verify-route-matrix.sh. Profile digest: 3c7498ae4594. Update with `workflows update --force`; consumer edits may be overwritten.
